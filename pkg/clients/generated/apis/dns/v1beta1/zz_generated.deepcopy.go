...
func (in *DNSRecordSetSpec) DeepCopyInto(out *DNSRecordSetSpec) {
	*out = *in
	...
	if in.Rrdatas != nil {
		...
		*out = make([]RecordsetRrdatas, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecordsetName) DeepCopyInto(out *RecordsetName) {
	*out = *in
	if in.DnsAuthorizationsRef != nil {
		in, out := &in.DnsAuthorizationsRef, &out.DnsAuthorizationsRef
		*out = new(v1alpha1.ResourceRef)
		**out = **in
	}
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecordsetName.
func (in *RecordsetName) DeepCopy() *RecordsetName {
	if in == nil {
		return nil
	}
	out := new(RecordsetName)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecordsetRrdatas) DeepCopyInto(out *RecordsetRrdatas) {
	*out = *in
	if in.DnsAuthorizationsRef != nil {
		in, out := &in.DnsAuthorizationsRef, &out.DnsAuthorizationsRef
		*out = new(v1alpha1.ResourceRef)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecordsetRrdatas.
func (in *RecordsetRrdatas) DeepCopy() *RecordsetRrdatas {
	if in == nil {
		return nil
	}
	out := new(RecordsetRrdatas)
	in.DeepCopyInto(out)
	return out
}
